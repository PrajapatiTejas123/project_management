             ...
             <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" value="{{old('address')}}" name="address" class="form-control" id="exampleInputPassword1" placeholder="Enter Date Of Birth">
                  @error('address')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
             ...
             <div class="row">
              ...
              <div class="col-md-6">
                ...
                <select id="roles" value="{{old('roles')}}" name="roles" class="form-control">
                    ...
                    <option  value="1" {{old('roles') == '1' ? "selected" : ""}}>Hr</option>
                    <option  value="2" {{old('roles') == '2' ? "selected" : ""}}>Project Manager</option>
                    <option  value="3" {{old('roles') == '3' ? "selected" : ""}}>Employee</option>
                </select>
                @error('roles')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
